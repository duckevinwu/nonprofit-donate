        ...
        <section className="text-gray-400 body-font bg-gray-900">
          <div className="container mx-auto flex px-5 py-24 lg:flex-row flex-col items-center md:items-start lg:items-center">
            ...
            <div className="flex flex-col items-center md:items-start md:flex-row lg:ml-auto">
              <button className="transition duration-150 ease-in-out mb-8 md:mb-0 md:mr-6 inline-flex text-white bg-gray-600 border-0 py-3 px-6 focus:outline-none hover:bg-gray-500 rounded text-lg">I'm a nonprofit</button>
              <button className="transition duration-150 ease-in-out inline-flex text-gray-700 bg-gray-100 border-0 py-3 px-6 focus:outline-none hover:bg-gray-500 hover:text-white rounded text-lg">I'm a for-profit</button>
            </div>
          </div>
        </section>
      </div>
